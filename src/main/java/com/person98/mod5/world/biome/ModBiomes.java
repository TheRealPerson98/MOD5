...
public class ModBiomes {
    ...
    public static RegistryKey<Biome> register(String name) {
        return RegistryKey.of(RegistryKeys.BIOME, new Identifier(Mod5.MOD_ID, name));
    }
    ...
    public static Biome testBiome(Registerable<Biome> context) {
        ...
        spawnBuilder.spawn(SpawnGroup.CREATURE, new SpawnSettings.SpawnEntry(ModEntities.COREY, 16, 3, 5));
        spawnBuilder.spawn(SpawnGroup.CREATURE, new SpawnSettings.SpawnEntry(ModEntities.COREY_CREEPER, 15, 1, 5));

        spawnBuilder.spawn(SpawnGroup.CREATURE, new SpawnSettings.SpawnEntry(EntityType.SHEEP, 15, 4, 4));
        ...
        return new Biome.Builder()
                ...
                .effects((new BiomeEffects.Builder())
                        .waterColor(0x28B2BA)
                        .waterFogColor(0x228085)
                        .skyColor(0xFA00E3)
                        .grassColor(0x176527)
                        .foliageColor(0x000EFF)
                        .fogColor(0xD6FF00)
